...
const SIGNAL_LABELS_TR: Record<string, string> = {
  ...
  sopr:                 'SOPR',
  sopr_ratio:           'Kohort Dengesi (LTH/STH)',
  ...
  spot_taker:           'Spot Alıcı/Satıcı',
  btc_liquidations:     'BTC Tasfiyeler',
  korean_premium:       'Kore Primi',
  // ETH-specific
  eth_supply_ratio:     'Borsa Arz Oranı',
  eth_active_addresses: 'Aktif Cüzdanlar',
  // XRP-specific
  xrp_liquidations:     'XRP Tasfiyeler',
  xrp_taker_buy_sell:   'XRP Alıcı/Satıcı',
  xrp_supply_ratio:     'XRP Borsa Arzı',
  xrp_nvt:              'NVT Oranı',
  xrp_tx_count:         'İşlem Sayısı',
};
