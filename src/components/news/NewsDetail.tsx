...
export default function NewsDetail({
  ...
  const aiSummary = item?.dashboard_summary || item?.summary || '';
  const marketAnalysis = item?.axiom_analysis || '';
  // analyzed=false → backend henüz Gemini batch'ine sokmamış. SSE ile gelen
  // update'de analyzed=true olur ve içerik dolar. Bu arada kullanıcıya
  // "hata" değil "hazırlanıyor" göster.
